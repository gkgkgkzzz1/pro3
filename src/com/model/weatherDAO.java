      ...
      StringBuffer sb1 = null;
        try {
            ...
            for (int i=0;i< parse_listArr.size();i++) {
                ...
                //sb1.append("시간 : " + dataTime + " 경기:" + gyeonggi + " 경북:" + gyeongbuk  + " 경남:" + gyeongnam + " 전북:" + jeonbuk + " 전남:" + jeonnam +" 서울:" + seoul +" 부산 :" + busan + " 광주 :"+ gwangju + " 대구:" + daegu + " 대전:" + daejeon + " 제주:" + jeju);
   ...
   public static ArrayList<String> uvtoday() {
      ...
      try {
           ...
           StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/LivingWthrIdxService01/getUVIdx"); /*URL*/
             urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=41exlFGitZU3xRpfc4vMNZpHK1ymsZFqeTSeoSFFzVJ1FBrVdlf8wqY%2FKpz0TMR6%2BSxSTCMDaysaPWPIvqAl7w%3D%3D"); /*Service Key*/
             urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("-", "UTF-8")); /*공공데이터포털에서 받은 인증키*/
             urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
             urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
             urlBuilder.append("&" + URLEncoder.encode("dataType","UTF-8") + "=" + URLEncoder.encode("json", "UTF-8")); /*요청자료형식(XML/JSON) Default: XML*/
             urlBuilder.append("&" + URLEncoder.encode("areaNo","UTF-8") + "=" + URLEncoder.encode("1100000000", "UTF-8")); /*서울지점 (공백일떄: 전체지점조회)*/
             urlBuilder.append("&" + URLEncoder.encode("time","UTF-8") + "=" + URLEncoder.encode("2021021706", "UTF-8")); /*2017년 6월 8일 6시 발표*/
